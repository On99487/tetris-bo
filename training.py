...
import random
from dev import MUTATION_RATE, MUTATION_MIXING_RATE
...
class Nnet:
    def __init__(self, num_input, num_hidden1, num_hidden2, num_output):
        ...
        self.weight_input_hidden1 = np.random.uniform(
            -0.5, 0.5, size=(self.num_hidden1, self.num_input)
        )
        self.weight_hidden1_hidden2 = np.random.uniform(
            -0.5, 0.5, size=(self.num_hidden2, self.num_hidden1)
        )
        self.weight_hidden2_output = np.random.uniform(
            -0.5, 0.5, size=(self.num_output, self.num_hidden2)
        )
    ...
    def create_mixed_weights(self, net1: "Nnet", net2: "Nnet"):
        self.weight_input_hidden1 = Nnet.get_mix_from_arrays(
            net1.weight_input_hidden1, net2.weight_input_hidden1
        )
        self.weight_hidden1_hidden2 = Nnet.get_mix_from_arrays(
            net1.weight_hidden1_hidden2, net2.weight_hidden1_hidden2
        )
        self.weight_hidden2_output = Nnet.get_mix_from_arrays(
